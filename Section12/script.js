...
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    const displayDate = calcTimeDiff(date, acc.locale);
...
const calcTimeDiff = function (date, locale) {
  const now = new Date();
...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    // when the time expires, stop timers and log out user.
    if (time === 0) {
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    // Update UI
    if (counter) clearInterval(counter); //if previous counter exists.
...
console.log(+'23');
console.log(1 + '23');
console.log(Number.parseInt('23.4xxx', 10));
console.log(Number.parseFloat('23.4xxx', 10));
console.log(Number.isNaN(36));
console.log(Number.isNaN('36'));
console.log(+'2xy');
...
const ar1 = [1, 6, 7, 2, 3, 10, 4];
console.log(Math.max(...ar1));
const rand = Math.trunc(9 + Math.random() * (15 - 9)) + 1;
console.log(rand);

console.log(Number.MAX_SAFE_INTEGER);
console.log(243534213123242341232324234234n + 5n);
console.log(20n == 20); //true
console.log(20n === 20); //false
console.log(new Date());
//parse the string, but sometimes can be unreliable
console.log(new Date('Aug 02 2020 10:05:41'));
console.log(new Date(2037, 10, 19, 15, 23, 5));
console.log(new Date(0));
console.log(new Date(24 * 60 * 1000 * 60));
...
console.log(Intl.NumberFormat('ar-SY', options).format(num));

const ingredients = ['spinach', 'boba'];
